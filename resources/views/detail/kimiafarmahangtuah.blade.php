    ...
    <div class="container col-xxl-8 px-4 py-5">
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
            <div class="col-12 col-lg-6">
                ...
                <h2 class="display-5 fw-bold text-body-emphasis lh-1 mb-3">Apotek Kimia Farma Hangtuah</h2>
                <ul class="list-group list-group-flush mb-3">
                    <li class="list-group-item">
                        ...
                        <span class="text-body-secondary p-2 fs-6">Jl. Hangtuah No.158 B, Rejosari, Kec. Tenayan Raya, Kota Pekanbaru, Riau 28112</span>
                    </li>
                    ...
                    <li class="list-group-item">
                        ...
                        <span class="text-body-secondary p-2 fs-6">081110678164</span>
                    </li>
                    ...
                    <li class="list-group-item">
                        ...
                        <span class="text-body-secondary p-2 fs-6">Lat :0.5242076397250129</span>
                    </li>
                    <li class="list-group-item">
                        <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 21C15.5 17.4 19 14.1764 19 10.2C19 6.22355 15.866 3 12 3C8.13401 3 5 6.22355 5 10.2C5 14.1764 8.5 17.4 12 21Z" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        <span class="text-body-secondary p-2 fs-6">Long : 1,014,753,313,886,890</span>
                    </li>
            ...
            <div class="col-12 col-lg-6">
                <img src="{{ asset('images/apotek/APOTEK KIMIA FARMA HANGTUAH.jpeg') }}" alt="Apotek Hangtuah Bertuah" class="img-fluid" style="height: 70vh; width: 100%;">
            </div>
